...
- **Slack 集成**：通过 Slack DM 或 @mention 与 Claude Code 交互
...
```bash
# 克隆项目
git clone https://github.com/anthropics/heimerdinger.git
cd heimerdinger
...
1. **Claude Code 必须已安装**：确保本机已安装并配置好 [Claude Code](https://claude.ai/claude-code)
